...
read_verilog -library xil_defaultlib {
  {D:/data/data/24/ZYNQ/CNN _kernel/CNN _kernel.srcs/sources_1/new/Layer1.v}
  {D:/data/data/24/ZYNQ/CNN _kernel/CNN _kernel.srcs/sources_1/new/Layer2.v}
  {D:/data/data/24/ZYNQ/CNN _kernel/CNN _kernel.srcs/sources_1/new/Layer3.v}
  {D:/data/data/24/ZYNQ/CNN _kernel/CNN _kernel.srcs/sources_1/new/Layer4.v}
  {D:/data/data/24/ZYNQ/CNN _kernel/CNN _kernel.srcs/sources_1/new/Layer5.v}
  ...
  {D:/data/data/24/ZYNQ/CNN _kernel/CNN _kernel.srcs/sources_1/new/test2.v}
}
...
synth_design -top test2 -part xc7z020clg400-2


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef test2.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file test2_utilization_synth.rpt -pb test2_utilization_synth.pb"
