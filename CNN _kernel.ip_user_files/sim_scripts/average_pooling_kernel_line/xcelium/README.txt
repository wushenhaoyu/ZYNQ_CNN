...
#
# Generated by export_simulation on Sun Jun 30 09:58:47 +0800 2024
#
################################################################################
...
./average_pooling_kernel_line.sh
...
'-reset_run' switch to the './average_pooling_kernel_line.sh' script.

./average_pooling_kernel_line.sh -reset_run
...
./average_pooling_kernel_line.sh -noclean_files

For more information on the script, please type './average_pooling_kernel_line.sh -help'.
