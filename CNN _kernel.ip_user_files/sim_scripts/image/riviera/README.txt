...
#
# Generated by export_simulation on Sat Jun 29 12:28:17 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './image.sh' script.
...
./image.sh -noclean_files

For more information on the script, please type './image.sh -help'.
